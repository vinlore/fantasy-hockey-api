...
class CreateStatsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('stats_year', function(Blueprint $table) {
            $this->create_table($table);
        });
        Schema::table('stats_year', function(Blueprint $table) {
            $table->string('years');
        });
        Schema::create('stats_week', function(Blueprint $table) {
            $this->create_table($table);
        });
        Schema::create('stats_biweek', function(Blueprint $table) {
            $this->create_table($table);
        });
        Schema::create('stats_month', function(Blueprint $table) {
            $this->create_table($table);
        });
    }
    ...
    {
        Schema::dropIfExists('stats_year');
        Schema::dropIfExists('stats_month');
        Schema::dropIfExists('stats_biweek');
        Schema::dropIfExists('stats_week');
    }

    public function create_table(Blueprint $table)
    {
        $table->increments('id');
